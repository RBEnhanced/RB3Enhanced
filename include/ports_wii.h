...
#define PORT_GEMTRACKRESOURCEMANAGER_GETFREESMASHERPLATE_BNE 0x80431884 // bne instruction in GemTrackResourceManager::GetFreeSmasherPlate
// #define PORT_LOADOBJS_BCTRL 0x827562e4
// function patch addresses
#define PORT_RNDDIR_NEWOBJECT 0x80638c5c
#define PORT_GEMTRACKRESOURCEMANAGER_RELEASESMASHERPLATE 0x804318c8
#define PORT_GEMTRACKRESOURCEMANAGER_GETFREESMASHERPLATE 0x80431830
#define PORT_SONGDATA_GETPHRASELIST 0x8048086c
